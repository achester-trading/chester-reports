...
The `pillar` field is informational — it lets the Monthly Macro writer slot
each pulled value into the right section without a separate mapping table.
"""
...
# Organized by Monthly Macro Report pillar for readability.
# ---------------------------------------------------------------------------
...
ENABLED_SOURCES = {
    "fred":      True,
    "eia":       False,  # add later
    "cftc":      False,  # add later
    "coingecko": False,  # add later
}
