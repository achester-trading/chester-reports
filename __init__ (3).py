...
For the data scale here (~50 series, monthly run), CSV is fine. We can swap
to parquet later by changing only this file.
"""
...
class Store:
    ...
    def latest(self, key: str) -> Optional[dict]:
        ...
        if not rows:
            return None
        # Filter out None values for "latest valid"
